...
public class TaskItem {
    ...
    public TaskItem(String title, String description, String dueDate, boolean comStatus) throws IllegalArgumentException{
        if(isTitleValid(title)){
            this.title = title;
        } else {
            throw new IllegalArgumentException("WARNING: title must be at least 1 character long; task not set");
        }
    ...
    public void setDueDate(String dd){
        if(isDateValid(dd)){
            ...
            throw new IllegalArgumentException("WARNING: invalid due date; task not set");
        }
    }
